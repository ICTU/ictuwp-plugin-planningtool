...
class DO_PT_SystemCheck {
    ...
    public function __construct() {
        $this->options = get_site_option( 'do_pt_systemcheck_v1.0.5' );
    }
    ...
    private function dismissMessages() {
        if ( isset( $_REQUEST['dismissMessage'] ) && isset( $_REQUEST['_wpnonce'] ) ) {
            ...
            if ( wp_verify_nonce( $nonce, "gcms-dismiss-{$key}" ) ) {
                ...
                update_site_option( 'do_pt_systemcheck_v1.0.5', $this->options );
            }
        }
    }
    ...
    private function checkWordPressVersion() {
        ...
        if ( !function_exists( 'wp_enqueue_media' ) ) {
            $error = "DO_Planningtool requires WordPress 3.5 or above. Please upgrade your WordPress installation.";
